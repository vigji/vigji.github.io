...
- [Cosyne 2022](https://youtu.be/-7gNchGxI9s?t=9056): A network that integrates heading direction in the larval zebrafish brain
- [Neuromatch 2020](https://www.youtube.com/watch?v=4tcbeLzrZ6I): BrainGlobe: a Python ecosystem for computational (neuro)anatomy

## Open source

- [Stytra](http://www.portugueslab.com/stytra/): a Python package to control stimulation and track behavior in zebrafish experiments
- [BrainGlobe](http://www.github.com/brainglobe): a Python toolbox for morphological analyses in systems neuroscience
